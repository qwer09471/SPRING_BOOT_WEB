...
public class Board {
    ...
    @Column(name = "user", nullable = false) // null x
    private String user = "";
    ...
    public void update(String user, String newdate, String count, String likec, String title, String content) { // 현재 객체 상태 업데이트
        this.user = user;
        this.content = content;
        this.title = title;
        this.newdate = newdate;
